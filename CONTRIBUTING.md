...
```sh
$ git clone https://github.com/<your-name>/khulnasoft-opensource
$ cd khulnasoft-opensource
$ npm install
```
...
*note for maintainers: All pull requests need a label to assist automation. See the [template](https://github.com/khulnasoft-opensource/khulnasoft-opensource/blob/HEAD/.github/release-drafter.yml) to guide which labels to use.*
...
If you would like to contribute to the project for the first time, please consider joining checking the [bug](https://github.com/khulnasoft-opensource/khulnasoft-opensource/issues?q=is%3Aissue+is%3Aopen+label%3A%22%F0%9F%90%9B+bug%22) or [good first issue](https://github.com/khulnasoft-opensource/khulnasoft-opensource/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) labels.
...
For those interested in getting involved in the project or just open source in general, please request an invite to the Triage Team in [this discussion.](https://github.com/khulnasoft-opensource/khulnasoft-opensource/discussions/638)

## Funding
Open Sauced is a part of GitHub Sponsors. If you would like to contribute, please note the [sponsor page](https://github.com/sponsors/khulnasoft-opensource) for details on how funds are distributed. If you have made any contributions to the projectd directly or indirectly, please consider adding your profile to the [funding.yml](https://github.com/khulnasoft-opensource/khulnasoft-opensource/blob/main/.github/funding.yml).

## Community

Do you have questions? Join the conversation in our [Discord](https://discord.gg/58KbV5w2).

## License

By contributing to the KhulnaSoft OpenSource project, you agree that your contributions will be licensed
